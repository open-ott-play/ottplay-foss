...
function getChanelsArray(cb) {
    _d_maxtv_load();
    var action = OttPlayCore.operatorSourceAction(_d_maxtv_cfg);
    if (action === "API") _d_maxtv_xtream(cb);
    else if (action === "PLAYLIST") _d_maxtv_m3u(cb);
    else {
