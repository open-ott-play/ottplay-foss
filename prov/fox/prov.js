...
function getChanelsArray(cb) {
    _fox_load();
    var action = OttPlayCore.operatorSourceAction(_fox_cfg);
    if (action === "API") _fox_xtream(cb);
    else if (action === "PLAYLIST") _fox_m3u(cb);
    else {
