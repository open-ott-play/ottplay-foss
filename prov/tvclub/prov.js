...
function getChanelsArray(cb) {
    _tvclub_load();
    var action = OttPlayCore.operatorSourceAction(_tvclub_cfg);
    if (action === "API") _tvclub_xtream(cb);
    else if (action === "PLAYLIST") _tvclub_m3u(cb);
    else {
