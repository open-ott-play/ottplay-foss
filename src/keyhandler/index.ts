...
export var keys: Record<string, number> = {
  ...
  ENTER: 13, RETURN: 8, EXIT: 27,
  PLAY: 80, PAUSE: 19, STOP: 83,
  RW: 33, FF: 34, PREV: 36, NEXT: 35,
  VOL_UP: 175, VOL_DOWN: 174, MUTE: 173,
  RED: 403, GREEN: 404, YELLOW: 405, BLUE: 406,
  INFO: 73, EPG: 0, TOOLS: 84, MENU: 179,
  PIP: 87, ASPECT: 65, ZOOM: 69, AUDIO: 83,
  SUBTITLE: 76, SETUP: 192, LANG: 16,
  CH_UP: 187, CH_DOWN: 189, CH_LIST: 0, POWER: 81,
  N0: 48, N1: 49, N2: 50, N3: 51, N4: 52,
  N5: 53, N6: 54, N7: 55, N8: 56, N9: 57,
  PRECH: 191, REC: 0, FAVORITES: 70,
};
...
export function keyHandler(event: KeyboardEvent): void {
  ...
  if (!keyCode) return;
  if (typeof (window as any).setSleepTimeout === 'function') (window as any).setSleepTimeout();

  /* dialog box (PIN pad, etc.) */
  try {
    if (typeof $ !== 'undefined' && $('#dialogbox').is(':visible')) {
      if (typeof (window as any).dialogBoxKeyHandler === 'function') (window as any).dialogBoxKeyHandler(keyCode);
      return;
    }
  } catch (_) { /* ignore */ }
  ...
  try {
    if (typeof $ !== 'undefined' && $('#listAbout').is(':visible')) {
      if (typeof (window as any).aboutKeyHandler === 'function' && (window as any).aboutKeyHandler(keyCode)) return;
      switch (keyCode) {
  ...
  try { if (typeof $ !== 'undefined' && $('#listEdit').is(':visible')) { handleEditKey(keyCode, event); return; } } catch (_) { /* ignore */ }
  if (isEditMode) { handleEditKey(keyCode, event); return; }
  if (isSelectBox) { handleSelectBoxKey(keyCode, event); return; }

  /* Global keys: POWER, MUTE, VOL_UP, VOL_DOWN — handled before list check (matching original) */
  switch (keyCode) {
    case keys.POWER:
      if (typeof (window as any).stbExit === 'function') (window as any).stbExit();
      if (typeof (window as any).toggleStandby === 'function') (window as any).toggleStandby();
      return;
    case keys.MUTE:
      if (typeof (window as any).stbToggleMute === 'function') (window as any).stbToggleMute();
      return;
    case keys.VOL_UP:
      if (typeof (window as any).changeVolume === 'function') { (window as any).changeVolume(settings.volumeStep); return; }
      break;
    case keys.VOL_DOWN:
      if (typeof (window as any).changeVolume === 'function') { (window as any).changeVolume(-settings.volumeStep); return; }
      break;
  ...
  if ((window as any).isListVisible) {
    console.log('DBG keyHandler: list visible, keyCode=' + keyCode + ' listKeyHandlerFn=' + (typeof listKeyHandlerFn));
...
function handleMainKey(keyCode: number, event: KeyboardEvent): void {
  ...
  switch (keyCode) {
    ...
    case keys.CH_LIST:
      ...
      if (typeof (window as any).channelsList === 'function') (window as any).channelsList((window as any).catIndex, (window as any).primaryIndex);
      break;
    case keys.RETURN:
      if (typeof (window as any).$i1 !== 'undefined' && (window as any).$i1.is(':visible')) {
        if (typeof (window as any).infoBarHide === 'function') (window as any).infoBarHide();
        break;
      }
      switch (settings.eFun) {
        case 0: break;
        case 1: if (typeof (window as any).exitPortal === 'function') (window as any).exitPortal(); break;
        case 2: if (typeof (window as any).joyMenu === 'function') (window as any).joyMenu(); break;
        case 3: if (typeof (window as any).popupList === 'function') (window as any).popupList(); break;
        case 4: if (typeof (window as any).prevProg === 'function') (window as any).prevProg(); break;
      }
      break;
    case keys.EXIT:
      if (typeof (window as any).exitPortal === 'function') (window as any).exitPortal();
      break;
    case keys.PLAY:
    case keys.PAUSE:
      if (typeof (window as any).stbContinue === 'function' && typeof (window as any).stbIsPlaying === 'function') {
        if ((window as any).stbIsPlaying()) { (window as any).stbPause(); }
        else { (window as any).stbContinue(); }
      }
      break;
    case keys.STOP:
      if (typeof (window as any).playChannel === 'function') {
        (window as any).playChannel((window as any).catIndex, (window as any).primaryIndex);
      }
      break;
    case keys.RW:
    ...
    case keys.MUTE:
      ...
      break;
    case keys.VOL_UP: {
      var vUp = (typeof (window as any).stbGetVolume === 'function' ? (window as any).stbGetVolume() : 50) + settings.volumeStep;
      if (vUp > 100) vUp = 100;
      if (typeof (window as any).stbSetVolume === 'function') (window as any).stbSetVolume(vUp);
      if (typeof (window as any).showShift === 'function') (window as any).showShift('Volume: ' + vUp);
      break;
    }
    case keys.VOL_DOWN: {
      var vDown = (typeof (window as any).stbGetVolume === 'function' ? (window as any).stbGetVolume() : 50) - settings.volumeStep;
      if (vDown < 0) vDown = 0;
      if (typeof (window as any).stbSetVolume === 'function') (window as any).stbSetVolume(vDown);
      if (typeof (window as any).showShift === 'function') (window as any).showShift('Volume: ' + vDown);
      break;
    }
    case keys.RED:
    ...
    case keys.POWER:
      ...
      break;
    case keys.INFO:
      if (typeof (window as any).showChanelInfo === 'function') (window as any).showChanelInfo(settings.infoTimeout);
      break;
    case keys.EPG:
      if ((window as any).playType > -1 && typeof (window as any).epgList === 'function') {
        (window as any).epgList((window as any).catIndex, (window as any).primaryIndex, false);
      }
      break;
    case keys.MENU:
    case keys.TOOLS:
      if (typeof (window as any).popupList === 'function') (window as any).popupList();
      break;
    case keys.PIP:
      if (typeof (window as any).togglePip === 'function') (window as any).togglePip();
      break;
    case keys.ASPECT:
      if (typeof (window as any).stbToggleAspectRatio === 'function') (window as any).stbToggleAspectRatio();
      break;
    case keys.ZOOM:
      if (typeof (window as any).stbToggleZoom === 'function') (window as any).stbToggleZoom();
      break;
    case keys.AUDIO:
      if (typeof (window as any).stbToggleAudioTrack === 'function') (window as any).stbToggleAudioTrack();
      break;
    case keys.SUBTITLE:
      if (typeof (window as any).stbToggleSubtitle === 'function') (window as any).stbToggleSubtitle();
      break;
    case keys.SETUP:
      (window as any).isListVisible = true;
      if (typeof (window as any).optionsList === 'function') (window as any).optionsList();
      break;
    case keys.CH_UP:
      if (typeof (window as any).plusProg === 'function') (window as any).plusProg();
      break;
    case keys.CH_DOWN:
      if (typeof (window as any).minusProg === 'function') (window as any).minusProg();
      break;
  }
}
...
function handleListKey(keyCode: number, event: KeyboardEvent): boolean {
  ...
  switch (keyCode) {
    case keys.UP:
      if (typeof (window as any).changeSelect === 'function') (window as any).changeSelect(-1);
      return true;
    case keys.DOWN:
      if (typeof (window as any).changeSelect === 'function') (window as any).changeSelect(1);
      return true;
    case keys.LEFT:
      if (typeof (window as any).changeSelect === 'function') (window as any).changeSelect(-((window as any).pageSize || 25));
      return true;
    case keys.RIGHT:
      if (typeof (window as any).changeSelect === 'function') (window as any).changeSelect(((window as any).pageSize || 25));
      return true;
...
function handleEditKey(keyCode: number, event: KeyboardEvent): void {
  ...
  if (event.key && event.key.length === 1) {
    ...
    var ep = (window as any).editPos !== undefined ? (window as any).editPos : ev.length;
    (window as any).editvar = ev.substr(0, ep) + event.key + ev.substr(ep);
    (window as any).editPos = ep + 1;
    if (typeof (window as any)._changeEdit === 'function') (window as any)._changeEdit();
    return;
  }
...
export function dispatchKey(keyCode: number, event?: Event): void {
  ...
  keyHandler({ keyCode: keyCode, preventDefault: function () { }, stopPropagation: function () { } } as any);
}
...
export function keyFun(fn: number): void {
  switch (fn) {
    case 0:
      if ((window as any).playType > -1 && typeof (window as any).recordsList === 'function') {
        (window as any).recordsList((window as any).catIndex, (window as any).primaryIndex, false);
      }
      return;
    case 1: if (typeof (window as any).popupList === 'function') (window as any).popupList(); return;
    case 2: if (typeof (window as any).prevProg === 'function') (window as any).prevProg(); return;
    case 3: if (typeof (window as any).shiftArchiveSelect === 'function') (window as any).shiftArchiveSelect(0); return;
    case 4: if (typeof (window as any).showChanelInfo === 'function') (window as any).showChanelInfo(); return;
    case 5: if (typeof (window as any).toggleAspectRatio === 'function') (window as any).toggleAspectRatio(); return;
    case 6: if (typeof (window as any).toggleAudioTrack === 'function') (window as any).toggleAudioTrack(); return;
    case 7: if (typeof (window as any).togglePip === 'function') (window as any).togglePip(); return;
    case 8: (window as any).pipIndex = null; if (typeof (window as any).stbStopPip === 'function') (window as any).stbStopPip(); return;
    case 9: if (typeof (window as any).bucketsList === 'function') (window as any).bucketsList((window as any).catIndex); return;
    case 10:
      if ((window as any).playType > -1 && typeof (window as any).epgList === 'function') {
        (window as any).epgList((window as any).catIndex, (window as any).primaryIndex, false);
      }
      return;
    case 11: if (typeof (window as any).popMedia === 'function') (window as any).popMedia(); return;
    case 12: if (typeof (window as any).joyMenu === 'function') (window as any).joyMenu(); return;
    case 13: if (typeof (window as any).changeVolume === 'function') (window as any).changeVolume((window as any).sVolumeStep); return;
    case 14: if (typeof (window as any).changeVolume === 'function') (window as any).changeVolume(-(window as any).sVolumeStep); return;
    case 15:
      if ((window as any).playType) { if (typeof (window as any).shiftArchiveSelect === 'function') (window as any).shiftArchiveSelect(60); }
      else if (typeof (window as any).plusProg === 'function') (window as any).plusProg();
      return;
    case 16:
      if ((window as any).playType) { if (typeof (window as any).shiftArchiveSelect === 'function') (window as any).shiftArchiveSelect(0); }
      else if (typeof (window as any).minusProg === 'function') (window as any).minusProg();
      return;
    case 17: if (typeof (window as any).toggleSubtitle === 'function') (window as any).toggleSubtitle(); return;
    case 18: if (typeof (window as any).shiftArchive === 'function') (window as any).shiftArchive(-60); return;
    case 19:
      if ((window as any).playType) { if (typeof (window as any).shiftArchive === 'function') (window as any).shiftArchive(60); }
      else if (typeof (window as any).shiftArchiveSelect === 'function') (window as any).shiftArchiveSelect(-60);
      return;
    case 20:
      if ((window as any).playType < 0) { if (typeof (window as any).shiftArchive === 'function') (window as any).shiftArchive(-6e6); return; }
      if (!(window as any).playType) { if (typeof (window as any).timeShift === 'function') (window as any).timeShift(0); return; }
      if ((window as any).playType + (window as any).playTime - (window as any).epgArray[(window as any).curProg].time > 30) {
        if (typeof (window as any).playArchive === 'function') (window as any).playArchive((window as any).epgArray[(window as any).curProg].time);
      } else {
        if (typeof (window as any).playArchive === 'function') (window as any).playArchive((window as any).epgArray[(window as any).curProg - 1].time);
      }
      return;
    case 21:
      if ((window as any).playType < 0) return;
      if (!(window as any).playType) { if (typeof (window as any).shiftArchiveSelect === 'function') (window as any).shiftArchiveSelect(-60); return; }
      if ((window as any).epgArray[(window as any).curProg + 1].time < Date.now() / 1e3) {
        if (typeof (window as any).playArchive === 'function') (window as any).playArchive((window as any).epgArray[(window as any).curProg + 1].time);
      } else {
        if (typeof (window as any).showShift === 'function') (window as any).showShift(_('Live'));
        if (typeof (window as any).playChannel === 'function') (window as any).playChannel((window as any).catIndex, (window as any).primaryIndex);
      }
      return;
  }
}
...
// Touch handlers
var xDown: number = null, yDown: number = null, xUp: number, yUp: number, touch_locked = false;
var xMove1: number, yMove1: number, tCount: number;
var touch_min_sensY = Math.round(screen.height / 10);
var touch_min_sensX = Math.round(touch_min_sensY * (screen.width / screen.height) * 2);
 ...
 */
export function checkTap(e: number, t: number, r: number, s: number, n: number, i: number): boolean {
  if (Math.abs(e - r) < touch_min_sensX / 10 && Math.abs(t - s) < touch_min_sensX / 10) return true;
  return false;
}
 ...
 */
export function getDirection(e: number, t: number, r: number, s: number, n: number, i: number): number {
  var a = 0;
  if (r - e > n) a |= 4;
  else if (e - r > n) a |= 1;
  if (s - t > i) a |= 2;
...
export function numberProg(digit: number): void {
  ...
  if (nProg.length === 4) {
    if (nProg === '9999') {
      ...
      if (digit === 9 && typeof (window as any).popupList === 'function') (window as any).popupList();
    }
    return;
  }
  ...
  if (numProgEl) {
    numProgEl.innerHTML = nProg + (idx < 0 || idx >= ((window as any).curList ? (window as any).curList.length : 0) ? '' : '<br/>' + ((window as any).chanels && (window as any).curList && (window as any).chanels[(window as any).curList[idx]] ? (window as any).chanels[(window as any).curList[idx]].channel_name : ''));
  ...
  numTimeout = setTimeout(function () {
    ...
    nProg = '';
    if (e < 0 || e >= ((window as any).curList ? (window as any).curList.length : 0) || e === (window as any).primaryIndex) return;
    if (typeof (window as any).playChannel === 'function') (window as any).playChannel((window as any).catIndex, e);
  }, 2000);
}
...
function onPrevSelect(sel: number): void {
  ...
  if (prevArr[sel].t) {
    ...
    r = prevArr[sel].c;
    n = catsL && catsArrayL ? catsL[catsArrayL[r]].indexOf(prevArr[sel].ci) : -1;
    if (n === -1) {
      n = catsL && catsL[_('All')] ? catsL[_('All')].indexOf(prevArr[sel].ci) : -1;
      r = catsArrayL ? catsArrayL.indexOf(_('All')) : -1;
    }
    if (typeof (window as any).setCurrent === 'function') (window as any).setCurrent(r, n, true);
    if (typeof (window as any).getEPGchanelCached === 'function') {
      (window as any).getEPGchanelCached(chId, function (_t: any, epgData: any) {
        var recent: any[] = [];
        if (epgData !== null && epgData.length) {
          var ch = (window as any).chanels ? (window as any).chanels[chId] : null;
          var chRec = ((ch && ch.rec) || 0) * 60 * 60;
          var cutoff = Date.now() / 1e3 - chRec;
          var i: number;
          for (i = 0; i < epgData.length; i++) { if (epgData[i].time > cutoff) recent.push(epgData[i]); }
          recent.sort(function (a: any, b: any) { return a.time - b.time; });
        }
        (window as any).epgArray = recent;
        if (typeof (window as any).setCurProg === 'function') (window as any).setCurProg(chId, epgData, null);
        if (typeof (window as any).playArchive === 'function') (window as any).playArchive(ts);
      });
    }
  } else {
    ...
    r2 = prevArr[sel].c;
    n2 = catsL2 && catsArrayL2 ? catsL2[catsArrayL2[r2]].indexOf(prevArr[sel].ci) : -1;
    if (n2 === -1) {
      n2 = catsL2 && catsL2[_('All')] ? catsL2[_('All')].indexOf(prevArr[sel].ci) : -1;
      r2 = catsArrayL2 ? catsArrayL2.indexOf(_('All')) : -1;
    }
    if (typeof (window as any).playChannel === 'function') (window as any).playChannel(r2, n2);
  }
}
...
export function prevProg(): void {
  ...
  function timeToday(e: number): boolean {
    var t = Math.floor(Date.now() / 864e5) * 86400 + new Date().getTimezoneOffset() * 60;
  ...
  function fmtTime(e: number): string {
    return timeToday(e) ? (window as any).time2time(e) : (window as any).time2str ? (window as any).time2str(e) : '';
  }
  var r: number, n: number;
  /**
  ...
  function setFromEntry(entry: any): void {
    r = entry.c;
    n = ((window as any).cats && (window as any).catsArray) ? (window as any).cats[(window as any).catsArray[r]].indexOf(entry.ci) : -1;
    if (n !== -1) return;
    n = ((window as any).cats && (window as any).cats[_('All')]) ? (window as any).cats[_('All')].indexOf(entry.ci) : -1;
    r = (window as any).catsArray ? (window as any).catsArray.indexOf(_('All')) : -1;
  }
  switch (prevArr.length) {
    case 0: return;
    case 1:
      setFromEntry(prevArr[0]);
      if (typeof (window as any).playChannel === 'function') (window as any).playChannel(r, n);
      return;
    default:
      var items: string[] = [];
      prevArr.forEach(function (entry: any, idx: number, arr: any[]) {
        try {
          items.push(
            ((window as any).chanels && (window as any).chanels[entry.ci] ? (window as any).chanels[entry.ci].channel_name : '') +
            (entry.t ? '<span style="color:red;"> - ' + fmtTime(entry.t) + '</span>' : '') +
            (entry.e ? ' <span style="color:#f9bf3b;"><span style="color:#607d8b;">&#x02237; </span>' + entry.e + '</span>' : '')
          );
        } catch (e) { arr.splice(idx, 1); }
      });
...
function handleTouchStart(e: any): void {
  ...
  xUp = xDown; yUp = yDown; xMove1 = xDown; yMove1 = yDown;
}
...
function handleTouchMove(e: any): void {
  ...
  if (tCount === 1) {
    var dir = Math.abs(xUp - xMove1) > Math.abs(yUp - yMove1)
      ? (xUp > xMove1 ? 4 : 1)
      : (yUp > yMove1 ? 2 : 8);
...
function handleTouchEnd(e: any): void {
  if (tCount === 3) {
    if (Math.abs(xUp - xDown) < touch_min_sensX * 5 && Math.abs(yUp - yDown) < touch_min_sensY * 2)
      (window as any)._doKey((window as any).keys.SETUP);
  }
  xDown = null; yDown = null; tCount = undefined;
}
...
function body_handleTouchEnd(e: any): void {
  ...
  if (e.touches.length === 0) {
    if (tCount === 3) {
      ...
      if (checkTap(xDown, yDown, xUp, yUp, touch_min_sensX * 5, touch_min_sensY * 2))
        (window as any)._doKey((window as any).keys.SETUP);
    } else if (tCount === 2) {
      // 2-finger gestures → color keys or ENTER
      var dir = getDirection(xDown, yDown, xUp, yUp, touch_min_sensX, touch_min_sensY * 2);
      switch (dir) {
        case 0:
          if (checkTap(xDown, yDown, xUp, yUp, touch_min_sensX / 2, touch_min_sensY / 2))
            (window as any)._doKey((window as any).keys.ENTER);
          break;
        case 1: (window as any)._doKey((window as any).keys.RED); break;
        case 4: (window as any)._doKey((window as any).keys.BLUE); break;
        case 2: (window as any)._doKey((window as any).keys.YELLOW); break;
        case 8: (window as any)._doKey((window as any).keys.GREEN); break;
      }
    } else if (tCount === 1) {
...
document.body.addEventListener('touchend', body_handleTouchEnd, { passive: false });
