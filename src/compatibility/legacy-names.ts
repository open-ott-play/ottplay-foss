...
export const legacyPlayerBindings: Array<[string, string]> = [
    ...
    ["epgCacheByChannel", "epgCashObj"],
    ["epgCacheChannelOrder", "epgCashArr"],
    ...
    ["currentProgramRequestQueue", "arrayGetCurProg"],
    ["processCurrentProgramQueue", "doGetCurProg"],
    ["epgListMode", "epglisted"],
    ["loadEpgListData", "epgShow_miniproc"],
    ["showMissingEpgNotice", "epgCheckEmpty_miniproc"],
