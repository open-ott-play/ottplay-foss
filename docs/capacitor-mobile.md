...
- **PC/Tauri native editor default** — PR #352 — unset `sEditor` defaults to `1` (native `<input>` / `showEditKey2`); explicit saved `sEditor=0` still respected
